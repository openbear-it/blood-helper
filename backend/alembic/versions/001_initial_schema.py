...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("hospital_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("hospitals.id"), nullable=False),
        sa.Column("blood_type", sa.Enum("A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-", name="bloodtype", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("reason", sa.Enum("expired", "contaminated", "administrative", "other", name="wastagEreason", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("blood_type", sa.Enum("A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-", name="bloodtype", create_type=False), nullable=False),
        sa.Column("horizon", sa.Enum("daily", "weekly", "monthly", name="forecasthorizon", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("draft", "active", "completed", "cancelled", name="campaignstatus", create_type=False), nullable=False, server_default="draft"),
        sa.Column("created_at", sa.DateTime(), nullable=False, server_default=sa.func.now()),
